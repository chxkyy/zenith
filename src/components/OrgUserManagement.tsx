...
import { MoreHorizontal, Search, Building2, Plus, ChevronDown, ChevronRight, Users2, UserPlus, RefreshCw, Edit, Trash2, RefreshCw as ResetIcon, User, Shield } from 'lucide-react';
    ...
    <div className="p-8 space-y-6">
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-3">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden h-[calc(100vh-300px)]">
