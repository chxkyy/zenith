 ...
 * 待评分列表查询执行器
 *
 * <p>返回所有处于 PENDING_REVIEW 状态的申请，按创建时间升序排列，
 * 便于评分人员优先处理较早提交的申请。</p>
 */
@Component
@RequiredArgsConstructor
public class InstAdmissionPendingReviewQryExe {
    ...
    public Page<InstAdmissionDTO> execute(InstAdmissionPageQuery query) {
        ...
        // 执行分页查询
        Page<InstAdmissionDO> resultPage = admissionMapper.selectPendingReview(page);
